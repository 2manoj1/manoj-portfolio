          ...
          <article aria-labelledby="about-profile-title">
            <Card className="border-border bg-card/30 p-0 shadow-sm shadow-black/5 overflow-visible">
              ...
              <div className="relative w-full aspect-[2.8/1] md:aspect-[3.6/1] rounded-t-2xl overflow-hidden border-b border-border/80 bg-secondary/20">
                ...
                />
                <div
                  className="absolute right-[2.65%] bottom-[4.5%] hidden rounded-sm bg-white p-[0.35%] shadow-sm md:block"
                  aria-hidden="true"
                >
                  <Image
                    src="/manoj_qr.png"
              ...
              <CardContent className="grid gap-7 p-5 md:grid-cols-[208px_minmax(0,1fr)_150px] md:items-stretch md:p-6 md:gap-8 overflow-visible">
                ...
                >
                  <header>
                    ...
                    <p className="mt-4 font-display text-balance text-lg md:text-xl font-normal leading-relaxed text-foreground">
                      I design and ship production AI systems for teams that
                      need architecture depth, platform reliability, and real
                      business execution.
                    </p>

                    {/* Description */}
                    <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                      AI Architect Consultant focused on multi-agent
                      orchestration, enterprise RAG systems, FastAPI AI
                      backends, and AI platform engineering for CTOs, startups,
                ...
                <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-border bg-secondary/35 p-4 text-center md:justify-between md:py-6 md:h-full md:self-end">
                  <div className="rounded border border-border bg-white p-1.5">
                    <Image
                      src="/manoj_qr.png"
                      alt="Scan to open Manoj Mukherjee's LinkedIn profile"
                      width={84}
                      height={84}
                      unoptimized
        ...
        <div className="mt-10 grid gap-3 md:grid-cols-2">
          <div className="border border-border p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-muted-foreground">
              AI architecture for complex enterprise workflows including
              multi-agent systems, hybrid retrieval pipelines, FastAPI service
              backends, deployment topologies, and observability models that
              survive production traffic and governance pressure.
            </p>
          </div>
          <div className="border border-border p-5">
            <h3 className="text-sm font-medium uppercase tracking-wide text-foreground">
            ...
            <p className="mt-3 text-sm leading-7 text-muted-foreground">
              Workshops, architecture audits, and embedded advisory with
              engineering and leadership teams. The goal is practical: clear
              decisions, reduced rework, faster release confidence, and stronger
        ...
        <div className="mt-10 grid gap-3 md:grid-cols-3">
          <div className="border border-border p-5 bg-card/10">
            ...
            <p className="mt-3 text-sm leading-6 text-muted-foreground">
              Designing model evaluation harnesses, safety filters, regression
              testing suites, and observability guardrails to guarantee LLM
              alignment and mitigate hallucinations.
            </p>
          </div>
          <div className="border border-border p-5 bg-card/10">
            <h3 className="text-sm font-medium uppercase tracking-wide text-foreground">
            ...
            <p className="mt-3 text-sm leading-6 text-muted-foreground">
              Optimizing vector search indexing, context window compaction,
              model fine-tuning topologies, and semantic caching to control
              cloud costs and guarantee sub-50ms budgets.
            </p>
          </div>
          <div className="border border-border p-5 bg-card/10">
            <h3 className="text-sm font-medium uppercase tracking-wide text-foreground">
            ...
            <p className="mt-3 text-sm leading-6 text-muted-foreground">
              Establishing solution architecture guilds, mentoring senior
              engineering teams, auditing vendor roadmaps, and translating
              abstract AI research into shipping code.
            </p>
          </div>
        </div>
      </Section>
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button asChild variant="outline" className="bg-background">
              <a href="/api/resume?download=1">Download PDF</a>
            </Button>
            <Button
              asChild
