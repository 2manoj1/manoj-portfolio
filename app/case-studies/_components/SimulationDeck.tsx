...
export function SimulationDeck({
  ...
  return (
    <div className="min-w-0 rounded-[8px] border border-zinc-200 bg-zinc-100/50 p-3.5 backdrop-blur-md dark:border-border/80 dark:bg-zinc-950/45 sm:p-4">
      ...
      <div className="mt-4 grid grid-cols-1 gap-2 min-[420px]:grid-cols-3">
        <button
          type="button"
          aria-pressed={activeMode === "HEALTHY"}
          onClick={() => onChangeMode("HEALTHY")}
          className={cn(
            "flex min-h-12 flex-row items-center justify-center gap-2 rounded-[8px] border px-3 py-2.5 text-center transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber min-[420px]:flex-col min-[420px]:gap-1.5",
            activeMode === "HEALTHY"
        ...
        <button
          type="button"
          aria-pressed={activeMode === "LATENCY"}
        ...
        <button
          type="button"
          aria-pressed={activeMode === "FAILURE"}
      ...
      <p
        aria-live="polite"
        className="mt-3 font-mono text-[10.5px] leading-relaxed text-zinc-600 dark:text-zinc-400 transition-all duration-200"
      >
