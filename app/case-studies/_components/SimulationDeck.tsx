...
export function SimulationDeck({
  ...
  return (
    <div className="min-w-0 rounded-lg border border-border/80 bg-zinc-950/45 p-4 backdrop-blur-md">
        ...
        <button
          ...
          className={cn(
            ...
            activeMode === "HEALTHY"
              ...
              : "border-border/60 bg-transparent text-zinc-400 hover:border-zinc-700 hover:bg-white/[0.015]"
          )}
        >
      ...
      <p className="mt-3 font-mono text-[10.5px] leading-relaxed text-zinc-400 transition-all duration-200">
