			...
			<div className="mx-auto max-w-7xl">
				<div className="mb-12 max-w-3xl">
					...
					<p className="mt-5 text-lg leading-8 text-zinc-400">
						I architect platforms that reduce cognitive overhead, accelerate
						automation, and scale the people building them.
					</p>
				</div>
				...
				<div className="grid gap-6 lg:grid-cols-3">
					...
					<Card className="bg-white/5 border-white/10 p-6 transition-all duration-300 hover:-translate-y-1 hover:bg-white/10">
						<CardHeader>
							...
							<CardDescription className="mt-2 text-zinc-400">
								Automation velocity improved across pipelines, retrieval, and
								deployment.
							</CardDescription>
						</CardHeader>
					</Card>
					...
					<Card className="bg-white/5 border-white/10 p-6 transition-all duration-300 hover:-translate-y-1 hover:bg-white/10">
						<CardHeader>
							...
							<CardDescription className="mt-2 text-zinc-400">
								Leaders and engineers coached in AI architecture, product
