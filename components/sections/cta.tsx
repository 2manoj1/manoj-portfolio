		...
		<section id="contact" className="relative py-24 px-6">
			...
			<div className="mx-auto max-w-6xl rounded-[2.5rem] border border-white/10 bg-slate-950/90 p-16 text-center shadow-2xl shadow-slate-950/50 backdrop-blur-3xl">
				...
				<h2 className="mt-6 text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
					Let’s build intelligent systems that
					<span className="block text-cyan-400">operate at platform scale</span>
					.
				</h2>
				<p className="mt-8 text-xl leading-9 text-zinc-300 sm:text-2xl max-w-4xl mx-auto">
					If you are defining the next generation of intelligent platforms, I
					help leadership turn architecture into a resilient, scalable
					intelligence layer.
				</p>
